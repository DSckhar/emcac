...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <button title="Adicionar Funcionário" class="btn btn-outline-dark" onclick="window.location.href='{{route('funcionario.create')}}'" ><span data-feather="user-plus"></span></button>
    </div>
</div>
    ...
    <table id="tabela" class="display table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="align-middle">
                    <button title="Editar Funcionário" class="btn btn-outline-dark" onclick="window.location.href='{{route('funcionario.edit', $funcionario->id)}}'" >
                        <span data-feather="edit"></span>
                    </button>
                </td>
                <td class="align-middle">
                    <button title="Apagar Funcionário" class="btn btn-outline-danger" onclick="window.location.href='{{route('funcionario.delete', $funcionario->id)}}'" >
