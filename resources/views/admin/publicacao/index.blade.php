...
@section('adm')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <button class="btn btn-outline-dark" onclick="window.location.href='/admr/publicacao/cadastrar'" ><span data-feather="plus"></span></button>
            <button class="btn btn-outline-dark" onclick="window.location.href='/admr/tipopublicacao'" >Tipos de Publicações</button>
        </div>
    </div>
