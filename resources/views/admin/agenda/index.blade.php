...
@section('adm')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <button title="Adicionar Marcação" class="btn btn-outline-dark" onclick="window.location.href='{{route('agenda.create')}}'" ><span data-feather="plus"></span></button>
        </div>
    </div>
        ...
        <table id="tabela" class="display table table-striped" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button title="Editar Marcação" class="btn btn-outline-dark" onclick="window.location.href='{{route('agenda.edit', $agenda->id)}}'" >
                            <span data-feather="edit"></span>
                        </button>
                    </td>
                    <td>
                        <button title="Apagar Marcação" class="btn btn-outline-danger" onclick="window.location.href='{{route('agenda.delete', $agenda->id)}}'" >
